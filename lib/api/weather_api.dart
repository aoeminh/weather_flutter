...
abstract class WeatherApi {
  ...
  Future<WeatherForecastListResponse> fetchWeatherForecast(double? lat,
      double? lon, String units,
      {String lang = 'en'});

  Future<WeatherForecastDaily> fetchWeatherForecast7Day(double? lat,
      double? lon, String units, String exclude,
      {String lang = 'en'});

  Future<AirPollutionResponse> fetchAirPollution(double? lat,
      double? lon); //current not
  // use
  Future<AirResponse> getAirPollution(double? lat, double? lon); //c
